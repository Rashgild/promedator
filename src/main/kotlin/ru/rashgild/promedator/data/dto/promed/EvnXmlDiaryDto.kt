...
data class EvnXmlDiaryDto(
    ...
    val xmlTypeId: String = "3",

    @JsonProperty("EvnXml_Data")
    val evnXmlData: String,

    @JsonProperty("XmlTemplateHtml_HtmlTemplate")
    val xmlHtmlTemplate: String = ("<div class='printonly' style='display: block;'><div class='template-block' "
